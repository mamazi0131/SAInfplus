...
from baseline.rankers import SAInf_rankrnn
...
def train(config, train_dataloader, eval_dataloader, threshold):
    ...
    model = SAInf_rankrnn(num_camera, num_grid, hidden_dim, threshold).cuda()    
    ...
    model_name = 'SAInf_rankrnn_{}_{}_{}'.format(region, num_epochs, nowtime)
    model_path = os.path.join(save_path, 'SAInf_rankrnn_{}_{}'.format(region, nowtime), 'model')
    log_path = os.path.join(save_path, 'SAInf_rankrnn_{}_{}'.format(region, nowtime), 'log')
    ...
    exp_path = os.path.join(save_path, 'SAInf_rankrnn_{}_{}'.format(region, nowtime))
    return exp_path
...
# dataset A
# ./exp/SAInf_A_240326141508
# acc:0.8324 auc:0.8833
# precision:0.5078 recall:0.9611 f1:0.6645
# hit@1:0.2710 hit@3:0.5719 hit@5:0.6853 SUM:1.5281
            
# # dataset B
# ./exp/SAInf_B_240326150324
# acc:0.7873 auc:0.8568
# precision:0.3606 recall:0.9489 f1:0.5226
# hit@1:0.2439 hit@3:0.4799 hit@5:0.6014 SUM:1.3252         

# dataset C
# ./exp/SAInf_C_240326162319
# acc:0.8224 auc:0.8755
# precision:0.4482 recall:0.9504 f1:0.6091
# hit@1:0.3605 hit@3:0.5923 hit@5:0.6879 SUM:1.6407
