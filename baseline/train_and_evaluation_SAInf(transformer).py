...
from baseline.rankers import SAInf_ranktransformer
...
def train(config, train_dataloader, eval_dataloader, threshold):
    ...
    model = SAInf_ranktransformer(num_camera, num_grid, hidden_dim, threshold).cuda()
    ...
    exp_path = os.path.join(save_path, 'SAInf_{}_{}'.format(region, nowtime))
    return exp_path
...
# dataset A
# ./exp/SAInf_A_240326000819
# acc:0.8324 auc:0.8833
# precision:0.5078 recall:0.9611 f1:0.6645
# hit@1:0.3726 hit@3:0.6525 hit@5:0.7639 SUM:1.7890
            
# dataset B
# ./exp/SAInf_B_240326023121
# acc:0.7873 auc:0.8568
# precision:0.3606 recall:0.9489 f1:0.5226
# hit@1:0.3195 hit@3:0.5441 hit@5:0.6731 SUM:1.5367
            
# dataset C
# ./exp/SAInf_C_240326105508
# acc:0.8224 auc:0.8755
# precision:0.4482 recall:0.9504 f1:0.6091
# hit@1:0.4212 hit@3:0.6632 hit@5:0.7617 SUM:1.8462        